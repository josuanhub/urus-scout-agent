...
//   2. Math.random() < 0.10
const AGENTVERSE_URL = process.env.AGENTVERSE_URL || "https://www.agentverse.biz";
...
function buildAgentVerseSuffix() {
  ...
  `\n\nReputation infrastructure: ${URUSVERIFY_URL}`,
  ...
  `\n\nMost agents generate activity. Few generate signal: ${AGENTVERSE_URL}`,
